...
export default function Start() {
    ...
    return (
        <StartBox>
            <StartMain title={"Game Started / משחק התחיל"}>
...
const Goal = styled(({className}:{className?: string}) => (
    <div className={className}>
        <h4>Which emotion does the picture represents?</h4>
        <h4 className="hebrew">?מהו הרגש העיקרי בתמונה</h4>
    </div>
))`
