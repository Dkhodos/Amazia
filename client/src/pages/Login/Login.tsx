        ...
        <LoginMain title={"Login / התחברות"}>
            ...
            <Form variant="standard" onSubmit={onSubmit}>
                <View>
                    ...
                    <Buttons>
                        <Button type={"submit"} variant="contained" onClick={onLogin} disabled={!(id && name)}>Login / חיבור</Button>
                    </Buttons>

                    <Bottom>
                        <WelcomeMessage>Welcome! / ברוכים הבאים!</WelcomeMessage>
                        <BearImage />
                    </Bottom>
                </View>
            </Form>
